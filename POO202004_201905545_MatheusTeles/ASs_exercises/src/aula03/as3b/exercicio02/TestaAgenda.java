...
public class TestaAgenda {
	public static void main(String[] args) {
		...
		do {
			...
			case 2: System.out.println("Qual a posi��o do contato que deseja consultar?");
			int posicao = sc.nextInt();
			if(posicao >=i || posicao <= 0)
				System.out.println("\nNão existe essa posi��o");
			else
			...
			if(pos != 0)
			System.out.println("\nA posição de " + nome + " : " + pos);
			else
				System.out.println("\nO nome consultado n�o est� na lista");
			break;
			...
			System.out.println("\nOp��es:\n(1)Imprimir Agenda\n"
					+ "(2)Consultar informa��es da Pessoa\n(3)Quero saber a posi��o do contato\n(4)Remover pessoa\n(5)Sair");
					option = sc.nextInt();
					sc.nextLine();
